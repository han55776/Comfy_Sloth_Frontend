...
export const SIGN_UP_ERROR = 'SIGNSIGN_UP_ERRORUP';
...
export const REFUND_ORDER_BEGIN = 'REFUND_ORDER_BEGIN';
...
export const GET_ORDERS_BY_ID_BEGIN = 'GET_ORDERS_BY_ID_BEGIN';
export const GET_ORDERS_BY_ID_SUCCESS = 'GET_ORDERS_BY_ID_SUCCESS';
export const GET_ORDERS_BY_ID_ERROR = 'GET_ORDERS_BY_ID_ERROR';
